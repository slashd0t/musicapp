...
var stackedbarComponent = /** @class */ (function () {
    function stackedbarComponent(http) {
        this.http = http;
        this.SAMPLE_DATA = [];
    }
    ...
    stackedbarComponent.prototype.initMargins = function () {
        this.margin = { top: 20, right: 20, bottom: 30, left: 40 };
    };
    stackedbarComponent.prototype.initSvg = function () {
    ...
    stackedbarComponent.prototype.drawChart = function (data) {
        var _this = this;
    ...
    stackedbarComponent = __decorate([
        core_1.Component({
            selector: 'about',
            styleUrls: ['./app/components/about/stackedbar.component.css'],
            templateUrl: './app/components/about/stackedbar.component.html'
        }),
